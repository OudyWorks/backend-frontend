...
/******/ 	return __webpack_require__(__webpack_require__.s = "../source/build/bundle.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./router */ "../source/build/router.js");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./store */ "../source/build/store.js");
/* harmony import */ var _i18n__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./i18n */ "../source/build/i18n.js");
/* harmony import */ var _meta__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./meta */ "../source/build/meta.js");
/* harmony import */ var LAYOUT__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! LAYOUT */ "../source/build/layouts/html/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  return new vue__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    render: function render(h) {
      return h(LAYOUT__WEBPACK_IMPORTED_MODULE_5__["default"]);
    },
    metaInfo: {
      titleTemplate: '%s - App'
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app */ "../source/build/app.js");

/* harmony default export */ __webpack_exports__["default"] = (function (context) {
  var _ = Object(_app__WEBPACK_IMPORTED_MODULE_0__["default"])(context);

  _.$router.push(context.url);

  return new Promise(function (resolve) {
    _.$router.onReady(function () {
      context.meta = _.$meta();
      resolve(_);
    });
  });
...
/***/ "../source/build/layouts/html/classes.js":
/*!***********************************************!*\
  !*** ../source/build/layouts/html/classes.js ***!
  \***********************************************/
/*! exports provided: default */
...
function classes(layout) {
  return {
    'page.container': ['tm-page-container'],
    'page': ['tm-page'],
    'header-mobile': ['tm-header-mobile', "uk-hidden@".concat(layout.mobile.breakpoint)],
    'toolbar': ['tm-toolbar', "uk-visible@".concat(layout.mobile.breakpoint), 'uk-hidden'],
    'toolbar.container': ['uk-container', 'uk-flex', 'uk-flex-middle', layout.toolbar.fullWith && 'uk-container-expand', layout.toolbar.center && 'uk-flex-center'],
    'header': ['tm-header', "uk-visible@".concat(layout.mobile.breakpoint)],
    'header.container': ['uk-container', layout.header.fullWith && 'uk-container-expand', layout.header.removeLogoPadding && 'uk-padding-remove-left'],
    'main': ['tm-main', 'uk-section', 'uk-section-default'],
    'main.container': ['uk-container'],
    'main.grid': ['uk-grid', layout.sidebar.gutter && "uk-grid-".concat(layout.sidebar.gutter), layout.sidebar.divider && 'uk-grid-divider'],
    'breadcrumbs': [layout.breadcrumbs && 'uk-margin-medium-bottom'],
    'sidebar': ['tm-sidebar', "uk-width-".concat(layout.sidebar.width, "@").concat(layout.sidebar.breakpoint), layout.sidebar.first && "uk-flex-first@".concat(layout.sidebar.breakpoint)],
    'footer': ['tm-footer', 'uk-section-secondary', 'uk-section', 'uk-section-small']
  };
}

/***/ }),

/***/ "../source/build/layouts/html/index.js":
/*!*********************************************!*\
  !*** ../source/build/layouts/html/index.js ***!
  \*********************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue */ "../node_modules/vue/dist/vue.runtime.esm.js");
/* harmony import */ var _classes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./classes */ "../source/build/layouts/html/classes.js");
...
var $application = {
  ...
  layout: {
    ...
    header: {
      ...
      //horizontal-left, horizontal-center, horizontal-right, stacked-center-a, stacked-center-b, stacked-center-split, stacked-left-a, stacked-left-b, offcanvas-top-a, offcanvas-top-b, offcanvas-center-a, offcanvas-center-b, modal-top-a, modal-top-b, modal-center-a, modal-center-b
      fullWidth: false,
  ...
  update: function update(to) {
    ...
    this.classes = Object(_classes__WEBPACK_IMPORTED_MODULE_1__["default"])(this.layout);
    to.matched.forEach(function (route) {
      return Object.keys(route.components).forEach(function (component) {
        if (route.components[component].classes) {
          var _classes = route.components[component].classes;
          if (typeof _classes == 'function') _classes = _classes(route.instances[component]);
          Object.keys(_classes).forEach(function (position) {
            if (_classes[position]) {
              if (_classes[position].set) _this.classes[position] = _classes[position].set;
              if (_classes[position].append) _this.classes[position] = _this.classes[position].concat(_classes[position].append);
              if (_classes[position].prepend) _this.classes[position] = _classes[position].prepend.concat(_this.classes[position]);
              if (_classes[position].remove && _this.classes[position]) _classes[position].remove.forEach(function (className) {
                var index = _this.classes[position].indexOf(className);

                if (index != -1) _this.classes[position].splice(index, 1);
              });
            }
          });
        }
  ...
  render: function render(position, h) {
    return this.modules && this.modules[position] && this.modules[position].map(function (module) {
      return h(APPLICATION.modules[module]);
    });
  }
};
vue__WEBPACK_IMPORTED_MODULE_0__["default"].use(function (Vue) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    this.$router.beforeEach(function (to, from, next) {
      _this2.$set(_this2.$store.state, 'busy', true);

      next();
    });
    this.$router.beforeResolve(function (to, from, next) {
      _this2.$application.update(to);

      next();
    });
    this.$router.onReady(function () {
      _this2.$application.update(_this2.$router.currentRoute);

      _this2.$set(_this2.$store.state, 'ready', true);
    });
    this.$router.afterEach(function (to, from) {
      _this2.$set(_this2.$store.state, 'busy', false);
    });
  },
  render: function render(h) {
    var application = this.$application,
      ...
      toggle: h("a", {
        ...
        if (application.layout.mobile.toggleText) elements[application.layout.mobile.toggle == 'right' ? 'unshift' : 'push'](h("span", {
          "class": "uk-margin-small-".concat(application.layout.mobile.toggle)
    ...
    var page = h("div", {
      "class": application.classes['page'],
      attrs: {
        hidden: !this.$store.state.ready
      }
    }, [h("div", {
      "class": application.classes['header-mobile']
    }, [h("nav", {
      "class": "uk-navbar-container uk-navbar",
      attrs: {
        "uk-navbar": ""
      }
    }, [['logo', 'toggle', 'search'].map(function (p) {
      return application.layout.mobile[p];
    }).includes('left') && h("div", {
      "class": "uk-navbar-left"
    }, [application.layout.mobile.toggle == 'left' && mobile.toggle]), application.layout.mobile['logo'] == 'center' && h("div", {
      "class": "uk-navbar-center"
    }, [mobile.logo]), ['logo', 'toggle', 'search'].map(function (p) {
      return application.layout.mobile[p];
    }).includes('right') && h("div", {
      "class": "uk-navbar-right"
    }, [application.layout.mobile.toggle == 'right' && mobile.toggle])]), h("div", {
      attrs: {
        id: "offcanvas",
        "uk-offcanvas": "",
        mode: "push",
        overlay: true,
        flip: application.layout.mobile.toggle == 'right'
      }
    }, [h("div", {
      ...
      "class": "uk-margin-auto-vertical uk-width-1-1"
    }, [h("h2", ["Hello offcanvas"])])])])]), h("div", {
      "class": application.classes['toolbar']
    }, [h("div", {
      "class": application.classes['toolbar.container']
    }, [h("div", [h("div", {
      "class": "uk-grid-medium uk-child-width-auto uk-flex-middle",
      attrs: {
        "uk-grid": "margin: uk-margin-small-top"
      }
    }, [toolbar.left, application.layout.toolbar.center && toolbar.right])]), !application.layout.toolbar.center && h("div", {
      ...
      "class": application.classes['header']
    }, [['horizontal-left', 'horizontal-center', 'horizontal-right'].includes(application.layout.header.layout) && function () {
      var $header = h("div", {
        "class": "uk-navbar-container"
      }, [h("div", {
        "class": application.classes['header.container']
      }, [h("nav", {
        attrs: {
          "uk-navbar": ""
        },
        ...
        "class": "uk-navbar-item"
      }, [application.render('header-logo', h)]), application.layout.header.layout == 'horizontal-left' && header.navbar]), h("div", {
        "class": "uk-navbar-center"
      }, [application.layout.header.layout == 'horizontal-center' && header.navbar]), h("div", {
        "class": "uk-navbar-right"
      }, [application.layout.header.layout == 'horizontal-right' && header.navbar, application.render('header', h)])])])]);
      return $header;
    }()]), h("div", [application.render('section-top', h)]), h("div", {
      "class": application.classes['main'],
      attrs: {
        "uk-height-viewport": "expand: true"
      }
    }, [h("div", {
      "class": application.classes['main.container']
    }, [h("div", {
      "class": application.classes['main.grid'],
      attrs: {
        "uk-grid": ""
      }
    }, [h("div", {
      "class": "uk-width-expand@".concat(application.layout.sidebar.breakpoint)
    }, [h("div", {
      "class": application.classes['breadcrumbs']
    }, [application.render('breadcrumbs', h)]), h("router-view", {
      ref: "view"
    })]), h("aside", {
      "class": application.classes['sidebar']
    })])])]), h("div", [application.render('section-bottom', h)]), h("footer", {
      "class": application.classes['footer']
    }, [application.render('footer', h)])]);
    if (application.layout.pageContainer) page = h("div", {
      "class": "tm-page-container"
    }, [page]);
    if (application.layout.offcanvas) page = h("div", {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue */ "../node_modules/vue/dist/vue.runtime.esm.js");
/* harmony import */ var vue_meta__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vue-meta */ "../node_modules/vue-meta/lib/vue-meta.js");
...
vue__WEBPACK_IMPORTED_MODULE_0__["default"].use(vue_meta__WEBPACK_IMPORTED_MODULE_1___default.a);
/* harmony default export */ __webpack_exports__["default"] = (true);

/***/ }),

/***/ "../source/build/router.js":
/*!*********************************!*\
  !*** ../source/build/router.js ***!
  \*********************************/
/*! exports provided: default */
...
var routes = __webpack_require__("./components sync recursive ([a-zA-Z0-9]+)[\\\\\\/](tasks[\\\\\\/]([a-zA-Z0-9]+)[\\\\\\/])?route.js$");

/* harmony default export */ __webpack_exports__["default"] = (new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  mode: 'history',
  routes: routes.keys().map(function (module) {
    var route = routes(module).default,
        _module$match = module.match(/([a-zA-Z0-9]+)[\\\/](tasks[\\\/]([a-zA-Z0-9]+)[\\\/])?route.js$/),
        _module$match2 = _slicedToArray(_module$match, 3),
        component = _module$match2[1],
        task = _module$match2[2],
        name = [component, task].filter(function (p) {
      return p;
    }).join('.');
...
/***/ "./components sync recursive ([a-zA-Z0-9]+)[\\\\\\/](tasks[\\\\\\/]([a-zA-Z0-9]+)[\\\\\\/])?route.js$":
/*!*****************************************************************************************!*\
  !*** ./components sync ([a-zA-Z0-9]+)[\\\/](tasks[\\\/]([a-zA-Z0-9]+)[\\\/])?route.js$ ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  component: {
    ...
    render: function render(h) {
      return h("div", [h("h2", ["Hello world!"]), h("router-link", {
        attrs: {
          to: "/test"
        }
      }, ["test"])]);
